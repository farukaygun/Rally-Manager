...
public class PlayButton : MonoBehaviour
{
  ...
  void InsertToTable()
  {
    ...
    DatabaseInsertion.InsertPilotsTotblPilots("Hamit", 31, 88, 99, 11111, "1");
    DatabaseInsertion.InsertPilotsTotblPilots("Halil", 31, 88, 99, 11111, "1");

    DatabaseInsertion.InsertSpecsTotblPilotSpecs(4, 4, 4, 4, 4, 5);
    DatabaseInsertion.InsertSpecsTotblPilotSpecs(4, 4, 4, 4, 4, 6);

    DatabaseInsertion.InsertPilotsTotblPilots("Hamdi", 31, 88, 99, 11111, "2");
    DatabaseInsertion.InsertPilotsTotblPilots("Ahmet", 26, 48, 79, 11111, "2");
    ...
    DatabaseInsertion.InsertCarsTotblCar("Araba 2", 1200, 35, 100, 200000, "1");
    DatabaseInsertion.InsertCarsTotblCar("Araba 3", 1200, 35, 100, 200000, "2");
    ...
    DatabaseInsertion.InsertTotblLeagues("WRC Junior", true);
    DatabaseInsertion.InsertTotblLeagues("WRC 3", false);
    DatabaseInsertion.InsertTotblLeagues("WRC 2", false);
